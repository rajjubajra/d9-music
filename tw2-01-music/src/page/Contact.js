    ...
    <div>
      ...
      <div className="w-full flex justify-center align-middle">
        ...
        <div>
          ...
          <input className="w-full md:w-1/2 border md:border-l-0 md:border-r md:border-t md:border-b-0 border-gray-500 p-2"  type="text" id="email" name="email" placeholder="Email" />
        </div>
        <div>
